...
export const reviews = [
  {
    ...
    artistId: "sicka",
    title: "7/1",
    cover: "https://i.postimg.cc/XYG2wW4L/file-00000000567081f4b1864f74771eacfe.png",
    releaseDate: "2026-07-31",
    reviewDate: "2026-08-01",
    label: "Farting Lesbians",
    text: "В этом треке сильное все — бит, флоу, звук, аутро, куплеты и припев. Конечно, засчет того, что второй куплет получился слишком длинным, соответствующий критерий становится слабым местом в песне, но это не отменяет его хитовый потенциал. Трек будет ещё долгое время считаться одним из эталонов дискографии Сики, так как на этом сингле она временно уходит в хиатус.",
    isSingle: true,
    singleCriteria: [
  ...
  {
    id: "pinkpantheress-illegal-single",
    artistId: "pinkpantheress",
    title: "Illegal",
    cover: "https://i.postimg.cc/V67S6hGV/IMG-20260801-204302-373.jpg",
    releaseDate: "2025-05-09",
    reviewDate: "2026-08-01",
    label: "Warner Records",
    text: "Один из самых ярких моментов Fancy That: гипнотический драм-н-бэйс-бит, цепкий припев и фирменная легкость PinkPantheress делают трек практически безупречным. Несмотря на минималистичную структуру, песня звучит свежо, мгновенно запоминается и обладает всеми качествами большого хита, что полностью оправдывает почти максимальные оценки.",
    isSingle: true,
    singleCriteria: [
  ...
  {
    id: "nicki-minaj-im-the-best-single",
    ...
    reviewDate: "2026-08-01",
    label: "Young Money",
    text: "Великолепный, вступительный рэп-трек альбома «Pink Friday», с элементами поп-синтов. В треке Ники читает как она поднялась на звание королевы рэпа из трущоб.",
    isSingle: true,
    singleCriteria: [
      { title: "Куплеты", score: 10 },
      { title: "Припев", score: 10 },
  ...
  },
  {
    ...
    text: "Холодная, уверенная подача Ice Spice здесь работает без осечек: цепкий флоу и запоминающиеся панчи идеально ложатся на мрачный дрилл-бит, создавая максимально дерзкую атмосферу. Трек не пытается быть сложным — он берет харизмой, вайбом и уверенностью, из-за чего легко запоминается.",
    isSingle: true,
    singleCriteria: [
      { title: "Куплеты", score: 10 },
      { title: "Припев", score: 10 },
  ...
  {
    id: "charli-xcx-card-declined-single",
    artistId: "charli-xcx",
    title: "Card Declined",
    cover: "https://i.postimg.cc/QM8xTbWz/file-0000000092b0820aaca869dcfa9618d2-(1).png",
    releaseDate: "2026-07-24",
    reviewDate: "2026-08-01",
    label: "Atlantic Records",
    text: "Мрачная гитарная эстетика и нарочито холодная подача создают необычную атмосферу, которая цепляет скорее настроением, чем мгновенной мелодичностью. Хотя песне немного не хватает очевидного хитового размаха, она запоминается своей смелой концепцией, сильным продакшеном и отлично передает отчужденное настроение новой эры Чарли.",
    isSingle: true,
    singleCriteria: [
  ...
  },
  {
    ...
    text: "Вдохновляясь своим хитом «MELON 18+» из оригинальной версии альбома «CUM MANIA», рэперка повторяет историю на новом треке делюкс-версии пластинки. Песня звучит очень заебисто, но главного героя теперь играют арбузики, можно сделать вывод, что Доллова поселилась в мире огорода у бабули в эре «CUM MANIA».",
    isSingle: true,
    singleCriteria: [
      { title: "Куплеты", score: 10 },
      { title: "Припев", score: 10 },
  ...
  {
    id: "ariana-grande-kiss-me-single",
    ...
    text: "Это тот случай, когда песня практически не оставляет слабых мест: безупречные вокальные партии, эмоциональная подача и идеально выстроенный продакшен делают каждый момент цепляющим. Трек ощущается как один из главных хайлайтов «petal».",
    isSingle: true,
    singleCriteria: [
      { title: "Куплеты", score: 10 },
      { title: "Припев", score: 10 },
  ...
  {
    id: "sicka-nyuhai-poppers-single",
    artistId: "sicka",
    isSingle: true,
    title: "NYUHAI POPPERS",
    cover: "https://i.postimg.cc/hjRQHG0z/file-00000000962881f487fdc47fd2aae38d.png",
    releaseDate: "2026-08-07",
    reviewDate: "2026-08-07",
    label: "Farting Lesbians",
    text: "Очень наглый трек, потому что артистка только пообещала уйти в хиатус, но сломала свое обещание, зато вновь обещает хиатус. Сама песня выстроена очень агрессивно с уклоном в денс в припевах и аутро. Этот сингл — одно из олицетворений абсурда всей дискографии артистки. Весь смысл в этом треке заложен в запоминании припева, что он и делает.",
    singleCriteria: [
      { title: "Куплеты", score: 8 },
      { title: "Припев", score: 9 },
      { title: "Дополнительно", score: 9 },
