...
export const reviews = [
  ...
  },
  {
    ...
    tracks: [
      ...
      { number: 2, title: "Freaking News" },
      { number: 3, title: "White House Hoe" },
      { number: 4, title: "The Choir" },
      { number: 5, title: "They Bow" },
      { isSection: true, title: "Transmission" },
      { number: 6, title: "Mrs. President (Interlude)" },
      { isSection: true, title: "Act II — Of SiCka" },
      { number: 7, title: "7/1" },
      { number: 8, title: "SiCka=gcd(x, ate)" },
      { number: 9, title: "??????" },
      { number: 10, title: "National Baddie" },
      { number: 11, title: "WMA" }
    ],
    criteria: [
      { title: "Биты" },
